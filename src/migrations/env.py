...
# Gather section names referring to different databases.  These are
# named "engine1", "engine2" in the sample .ini file.
db_names = config.get_main_option("databases", "")

# Add your model's MetaData objects here for 'autogenerate' support.
# These must be set up to hold just those tables targeting a
# particular database. table.tometadata() may be helpful here in case
# a "copy" of a MetaData is needed.
target_metadata = {
    "postgresql": Base.metadata,
